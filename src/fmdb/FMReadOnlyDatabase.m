...
@implementation FMReadOnlyDatabase
...
#pragma mark FMReadOnlyDatabase instantiation and deallocation
...
static int FMDBRODatabaseBusyHandler(void *f, int count) {
    FMReadOnlyDatabase *self = (__bridge FMReadOnlyDatabase*)f;
...
- (void)setMaxBusyRetryTimeInterval:(NSTimeInterval)timeout {
    ...
    if (timeout > 0) {
        sqlite3_busy_handler(_db, &FMDBRODatabaseBusyHandler, (__bridge void *)(self));
    }
    else {
